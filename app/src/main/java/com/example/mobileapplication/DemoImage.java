...
public class DemoImage extends AppCompatActivity implements View.OnClickListener{

    public static final String UPLOAD_URL = "http://10.0.2.2:8080/topstar/uplload.php";
